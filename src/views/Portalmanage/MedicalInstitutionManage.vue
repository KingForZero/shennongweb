  ...
  export default {
    ...
    methods: {
      ...
      findPage: function (data) {
        ...
        this.$api.portalmanage.medicalInstitutionFindPage(this.pageRequest).then((res) => {
          this.pageResult = res
      ...
      handleDelete: function (data) {
        ...
        this.$api.portalmanage.delMedicalInstitution(data.params[0]).then(data != null ? data.callback : '')
      },
      // 显示新增界面
      handleAdd: function () {
        ...
        this.$refs.dataForm.validate((valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              this.$api.portalmanage.addMedicalInstitution(params).then((res) => {
