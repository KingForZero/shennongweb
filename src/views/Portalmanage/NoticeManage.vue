    ...
    <el-dialog :title="operation?'新增':'修改'" width="60%" :visible.sync="dialogVisible" :close-on-click-modal="false" @close='closeDialog'>
      <el-form  :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
        ...
        <el-form-item label="标题" prop="title">
          <el-input v-model="dataForm.title" auto-complete="off" placeholder="标题"></el-input>
        </el-form-item>
        ...
        <el-form-item label="公告描述" prop="mark">
  ...
  export default {
    ...
    methods: {
      ...
      findPage: function (data) {
        ...
        this.$api.portalmanage.noticeFindPage(this.pageRequest).then((res) => {
          this.pageResult = res
      ...
      handleDelete: function (data) {
        ...
        this.$api.portalmanage.delNotice(data.params[0]).then(data != null ? data.callback : '')
      },
      // 显示新增界面
      handleAdd: function () {
        ...
        this.$refs.dataForm.validate((valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              this.$api.portalmanage.addNotice(params).then((res) => {
      ...
      initColumns: function () {
        this.columns = [
          ...
          {prop: "title", label: "标题", minWidth: 50},
