  ...
  <div class="page-container">
    ...
    <el-dialog :title="operation?'新增':'修改'" width="60%" :visible.sync="dialogVisible" :close-on-click-modal="false" @close='closeDialog'>
      <el-form  :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
        ...
        <el-form-item label="标题" prop="titla">
          <el-input v-model="dataForm.titla" auto-complete="off" placeholder="标题"></el-input>
        </el-form-item>
       ...
       <!--   <el-tooltip :content="'Switch value: ' + dataForm.is_flag" placement="top">-->
        ...
        <el-form-item label="临床表现" prop="symptom">
          <el-input v-model="dataForm.symptom" auto-complete="off" placeholder="临床表现"></el-input>
        </el-form-item>
        <el-form-item label="诱发原因" prop="inducingCause">
          <el-input v-model="dataForm.inducingCause" auto-complete="off" placeholder="诱发原因"></el-input>
        </el-form-item>
        <el-form-item label="推荐治疗" prop="recommendedTreatment">
          <el-input v-model="dataForm.recommendedTreatment" auto-complete="off" placeholder="推荐治疗"></el-input>
        </el-form-item>
        <el-form-item label="图片" prop="img">
         <!-- <el-input v-model="dataForm.img" auto-complete="off" placeholder="图片"></el-input>-->
          <div style="float: left">
            <el-upload
              :action="uploadUrl()"
              multiple
  ...
  export default {
    ...
    methods: {
      ...
      handleRemove(file, fileList) {
        this.fileChange(fileList);
        console.log("设置图片的地址222：："+this.dataForm.img)
      },
      // 设置photo值
      fileChange(fileList) {
        let temp_str = '';
        ...
        this.dataForm.img = temp_str;
        console.log("设置图片的地址：："+this.dataForm.img)
      },
      ...
      findPage: function (data) {
        ...
        this.$api.portalmanage.findPage(this.pageRequest).then((res) => {
          this.pageResult = res
      ...
      handleDelete: function (data) {
        ...
        this.$api.portalmanage.batchDelete(data.params[0]).then(data != null ? data.callback : '')
      },
      // 显示新增界面
      handleAdd: function () {
      ...
      handleEdit: function (params) {
        ...
        // params.row.isFlag
        this.config.initialContent =  params.row.mark
        // this.$api.assistant.selectDocWorkTimeById({"docId": params.row.id}).then((res) => {
        //   // 加载时间问题
        ...
        this.$refs.dataForm.validate((valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              this.dataForm.mark=_slef.getContent()
              ...
              this.$api.portalmanage.addCommonDiseases(params).then((res) => {
