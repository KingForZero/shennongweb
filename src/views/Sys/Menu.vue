  ...
  methods: {
    ...
    findTreeData: function() {
      ...
      this.$api.menu.findMenuTree().then(res => {
        ...
        this.popupTreeData = this.getParentMenuTree(res.rows);
        this.loading = false;
      });
    },
    // 获取上级菜单树
    ...
    handleEdit: function(row) {
      this.dialogVisible = true;
      console.log("合并之前的dataForm::"+JSON.stringify(this.dataForm))
      console.log("合并之前的row::"+JSON.stringify(row))
      Object.assign(this.dataForm, row);
      console.log("合并之后的dataForm::"+JSON.stringify(this.dataForm))
      console.log("合并之后的row::"+JSON.stringify(row))
    },
    // 删除
    handleDelete(row) {
