<template>
  <div class="page-container">
	...
	<kt-table permsEdit="sys:role:edit" permsDelete="sys:role:delete" :highlightCurrentRow="true" :stripe="false"
		:data="pageResult" :columns="columns" :showOperation="true" :showBatchDelete="true" @handleCurrentChange="handleRoleSelectChange"
	...
	methods: {
		...
		handleRoleSelectChange(val) {
			...
			this.$api.role.findRoleMenus({'roleId':val.val.id}).then((res) => {
				this.currentRoleMenus = res.rows
				this.$refs.menuTree.setCheckedNodes(res.rows)
			})
		},
		// 树节点选择监听
